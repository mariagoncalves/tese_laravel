...
@section('content')
    <div ng-controller="dashboardController">
        ...
        <br>
        <br>
        <button type="button" class="btn btn-lg btn-success" ng-click="openModalProcess('lg')">Add New Process</button>
        <button type="button" class="btn btn-lg btn-success" ng-click="openModalTask('lg')">Add New Task</button>
        <br>
        <br>
