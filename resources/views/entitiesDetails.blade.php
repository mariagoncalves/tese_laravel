	...
	<div ng-controller="dynamicSearchControllerJs"> 
		<div ng-init = "getEntitiesData({{$id}})">
			...
			<div ng-init = "getRelsWithEnt({{$id}})">
				...
				<!-- <div ng-repeat = "relWithEnt in relsWithEnt" ng-init = "getEntsRelated(relWithEnt.id)"> </div> -->
				<div ng-repeat = "relWithEnt in relsWithEnt"> </div>
				...
				<div ng-if="relsWithEnt.length > 0"> 
					<table class="table" border = "1px solid">
	                    ...
	                    <tbody>
	                    	...
	                    	<!-- <div ng-if = "entsRelated.ent_type1_id == ents.id" ng-init = "getPropsEntRelated(entsRelated.ent_type2_id)"></div> -->
			                ...
			                <!-- <tr ng-repeat="propEnt in entRelated.properties">
			                    <td>[[ propEnt.language[0].pivot.name ]]</td>
			                    <td> <input type="checkbox" name="checkRL" value="[[ propEnt.id ]]"> </td>
			                    <td>
			                    	<div ng-switch on="propEnt.value_type">
								        <div ng-switch-when="text"> <input type="text" name="textRL"> </div>
								        <div ng-switch-when="bool"> 
								        	<input type="radio" name="radioRL" value="true">True
											<input type="radio" name="radioRL" value="false">False 
										...
										<div ng-switch-when="enum">
											<select name = "selectRL" ng-init = "getEnumValues(propEnt.id)">
								        		<option ng-repeat = "propAllowedValue in propAllowedValues"> [[ propAllowedValue.language[0].pivot.name ]] </option>
								        	</select>
										</div>
										<div ng-switch-when="ent_ref"> 
											<select name = "ent_refER" ng-init = "getEntityInstances(ents.id, propEnt.id)">
								        		<option></option>
								        		<option ng-repeat = "inst in fkEnt.fk_ent_type.entity"> [[ inst.language[0].pivot.name ]] </option>
								        	</select>
										</div>
				...
				<!-- <div ng-repeat = "relWithEnt in relsWithEnt">  -->
					<!--<h3> Entidades que se relacionam com [[ents.language[0].pivot.name ]] </h3>
					...
					<div ng-if="relsWithEnt.length > 0"> 
						<table class="table" border = "1px solid">
		                    ...
		                    <tbody> -->
		                    	...
		                    	<!-- <div ng-repeat = "relWithEnt in relsWithEnt" ng-if = "relWithEnt.ent_type2_id == ents.id" ng-init = "getPropsEntRelated(relWithEnt.ent_type1_id)"> 2 é igual</div>
		                    	<div ng-repeat = "relWithEnt in relsWithEnt" ng-if = "relWithEnt.ent_type1_id == ents.id" ng-init = "getPropsEntRelated(relWithEnt.ent_type2_id)"> 1 é igual</div> -->

		                    	<!-- <div ng-repeat = "relWithEnt in relsWithEnt" ng-if = "relWithEnt.ent_type2_id == ents.id" ng-init = "getEntitiesData(relWithEnt.ent_type1_id)"> 2 é igual</div>

		                    	<div ng-repeat = "relWithEnt in relsWithEnt" ng-if = "relWithEnt.ent_type1_id == ents.id" ng-init = "getEntitiesData(relWithEnt.ent_type2_id)"> 1 é igual</div> -->
